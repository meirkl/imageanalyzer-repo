...
call mvn install:install-file -Dfile=".\lib\org.eclipse.cdt.core_6.7.0.jar" -DgroupId=org.eclipse.cdt -DartifactId=core -Dversion=6.7.0 -Dpackaging=jar -DlocalRepositoryPath="." -DgeneratePom=true -DcreateChecksum=true
